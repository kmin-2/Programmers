...
public class level1_02 {
	...
	예를 들어, new_id 값이 "...!@BaT#*..y.abcdefghijklm" 라면, 위 7단계를 거치고 나면  새로운 아이디는 "bat.y.abcdefghi" 입니다.*/
	
	 public static String solution(String new_id) {
	      
	        new_id = new_id.toLowerCase().replaceAll("[~!@#$%^&*()=+\\[\\{\\]\\}:?,<>/]","").replaceAll("\\.{2,}","."); //1~3단계
	        ...
	        if(new_id.length() <= 2){ //7단계
	            last_str += new_id.charAt(new_id.length()-1);
	...
	public static void main(String[] args) {
		...
		String test_id1 = "...!@BaT#*..y.abcdefghijklm";
		String test_id2 = "=.=";
		System.out.println(solution(test_id1));
		System.out.println(solution(test_id2));
	}
}
